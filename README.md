...
多模态测试断言引擎：从单一"执行"拓展至"验证"，定义场景级 pass/fail 规则，输出标准化测试报告。
数据隐私与私有部署：探索轻量级多模态模型（2B-7B VLM），实现局域网内的全离线 CUA 执行，构筑商业化落地的安全壁垒。
插件化生态：支持用户自定义操作模板、验证规则，构建开放生态。
...
飞书 CLI (lark-cli)
OSWorld 基准测试
Computer-Use Agent 概念


License: MIT


Author: JokerChen-peng
